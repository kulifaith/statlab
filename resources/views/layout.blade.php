...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/css/bootstrap-reboot.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('css/css/bootstrap-reboot.min.css') }}" />
