...
$(function(){
    ...
    $(function(){
        ...
        $('#date_recieved_by_hw').combodate({
            maxYear:new Date().getFullYear()
        });
        $('#date_recieved_by_lab').combodate({
            maxYear:new Date().getFullYear()
        });
    });
    ...
    */
     ...
     */
        ...
        /*Toggle summary div for blood transfusion*/
        $('#transfusion').click(function(){
            if ( $('#blood-transfusion').hasClass('hidden')) {
                    $('#blood-transfusion').removeClass('hidden');
            }else {
                $('#blood-transfusion').addClass('hidden');
            }
        });

        /*Toggle summary div for blood transfusion*/
        $('#hpv').click(function(){
            if ( $('#hpv-details').hasClass('hidden')) {
                    $('#hpv-details').removeClass('hidden');
            }else {
                $('#blood-transfusion').addClass('hidden');
            }
        });
